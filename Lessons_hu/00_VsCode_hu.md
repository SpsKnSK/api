# 🔧 VS Code használata – egyszerű lépések diákoknak
## 1. 📦 Mappa létrehozása a Dokumentumokban
- Nyisd meg a *Dokumentumok* mappát a gépeden.
- Hozz létre egy új mappát az osztályod nevével (pl. `2G`, `2K`).
- Az osztály mappán belül hozz létre egy új mappát a saját neveddel így:
    > 👉 **vezeteknev_keresztnev** (pl. `kovacs_anna`)
...
- Ha a kód nem fut, lehet, hogy telepíteni kell a Python-t vagy a Python bővítményt a `VS Code`-ba.